...
export const fixtureEquipmentTypes: EquipmentType[] = [
  { id: 'eq-barbell', name: 'Barbell', isSystem: true },
  { id: 'eq-dumbbell', name: 'Dumbbell', isSystem: true },
  { id: 'eq-cable', name: 'Cable Machine', isSystem: true },
  { id: 'eq-lever', name: 'Lever Machine', isSystem: true },
  { id: 'eq-smith', name: 'Smith Machine', isSystem: true },
  { id: 'eq-treadmill', name: 'Treadmill', isSystem: true },
  { id: 'eq-bike', name: 'Stationary Bike', isSystem: true },
  { id: 'eq-rower', name: 'Rowing Machine', isSystem: true },
  { id: 'eq-kettlebell', name: 'Kettlebell', isSystem: true },
  { id: 'eq-band', name: 'Resistance Band', isSystem: true },
  { id: 'eq-pullupbar', name: 'Pull-up Bar', isSystem: true },
  { id: 'eq-bench', name: 'Bench', isSystem: true },
  { id: 'eq-trx', name: 'TRX Straps', isSystem: false },
]
